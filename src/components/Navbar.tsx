    ...
    return (
        <>
            <header className="antialiased">
                <nav className="bg-white border-gray-200 pr-4 lg:pr-6 py-2.5 dark:bg-gray-800">
